// ==UserScript==
// @name         ▶ Open YouTube Optimizer 2.0 (EN ver.)
// @version      2.0
// @description  Advanced script to improve YouTube performance and simplify interface
        ...
        getCategories() {
            return {
                ...
                '🎬 Player': [
                    ...
                    { key: 'limitVideoQuality', label: 'Limit video quality', description: 'Sets maximum video quality' },
                    {
                        type: 'select',
                        key: 'maxQuality',
